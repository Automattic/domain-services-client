# Class: [\Automattic](../namespaces/automattic.md)[\Domain_Services](../namespaces/automattic-domain-services.md)[\Response](../namespaces/automattic-domain-services-response.md)[\Dns](../namespaces/automattic-domain-services-response-dns.md)\Get
...
##### SummaryReturns the DNS records associated with a domain
##### Throws:
