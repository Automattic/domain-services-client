	...
	public function test_command_instance_success(): void {
		$mock_command_data = [
			...
			Command\Command_Interface::PARAMS => [
				...
				Command\Command_Interface::KEY_PRIVACY_SETTINGS => Entity\Whois_Privacy::ENABLE_PRIVACY_SERVICE,
			],
		...
		$privacy_setting = new Entity\Whois_Privacy( $mock_command_data[ Command\Command_Interface::PARAMS ][ Command\Command_Interface::KEY_PRIVACY_SETTINGS ] );
		...
		$this->assertInstanceOf( Command\Domain\Set\Privacy::class, $command );
