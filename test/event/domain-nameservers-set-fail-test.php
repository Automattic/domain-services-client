...
class Domain_Nameservers_Set_Fail_Test extends Test\Lib\Domain_Services_Client_Test_Case {
	public function test_event_success(): void {
		...
		$this->assertInstanceOf( Event\Domain\Nameservers\Set\Fail::class, $event );
