...
class Domain_Notification_Argp_Test extends Test\Lib\Domain_Services_Client_Test_Case {
	public function test_event_success(): void {
		...
		$response_data = [
			...
			'data' => [
				'event' => [
					...
					'event_data' => [
						'argp_end_date' => '2022-01-28 23:45:01',
					],
				],
			],
		];
		...
		$this->assertSame( $response_data['data']['event']['event_data']['argp_end_date'], $event->get_argp_end_date()->format( Entity\Entity_Interface::DATE_FORMAT ) );
	}
}
