...
class Domain_Privacy_Set_Success_Test extends Test\Lib\Domain_Services_Client_Test_Case {
	public function test_event_success(): void {
		...
		$response_data = [
			...
			'data' => [
				'event' => [
					'id' => 1234,
					'event_class' => 'Domain_Privacy_Set',
		...
		$this->assertInstanceOf( Event\Domain\Privacy\Set\Success::class, $event );
