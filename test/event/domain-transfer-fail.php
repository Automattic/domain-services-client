...
class Domain_Transfer_Fail_Test extends Test\Lib\Domain_Services_Client_Test_Case {
	public function test_event_fail(): void {
		...
		$response_data = [
			...
			'data' => [
				'event' => [
					'id' => 1234,
					'event_class' => 'Domain\Transfer',
					'event_subclass' => 'Fail',
					'object_type' => 'domain',
					'object_id' => 'example.xyz',
					'event_date' => '2022-01-23 12:34:56',
					'acknowledged_date' => null,
					'event_data' => [
						'status' => Response\Code::INVALID_TRANSFER_REQUEST,
						'status_description' => Response\Code::get_description( Response\Code::INVALID_TRANSFER_REQUEST ),
						'client_txn_id' => 'test-client-transaction-id',
						'server_txn_id' => '5ffdba44-eeec-4647-9cc4-27cdf8352efc.local-isolated-test-request',
						'errors' => [
							[
								'description' => '.xyz TLD is not supported',
								'extra' => [],
							],
						],
					],
		...
		$this->assertInstanceOf( Event\Domain\Transfer\Fail::class, $event );
