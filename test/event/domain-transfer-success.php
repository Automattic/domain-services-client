...
class Domain_Transfer_Success_Test extends Test\Lib\Domain_Services_Client_Test_Case {
	public function test_event_success(): void {
			...
			'data' => [
				'event' => [
					...
					'event_data' => [
						...
						'status_description' => Response\Code::get_description( Response\Code::SUCCESS ),
						'client_txn_id' => 'test-client-transaction-id',
						'server_txn_id' => '5ffdba44-eeec-4647-9cc4-27cdf8352efc.local-isolated-test-request',
						'errors' => [],
					],
		...
		$this->assertInstanceOf( Event\Domain\Transfer\Success::class, $event );
