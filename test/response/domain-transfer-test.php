...
class Domain_Transfer_Test extends Test\Lib\Domain_Services_Client_Test_Case {
	public function test_response_factory_success(): void {
		...
		$command = new Command\Domain\Transfer( $domain, $auth_code, $contacts, $name_servers, $dns_records );
		...
		$this->assertInstanceOf( Response\Domain\Transfer::class, $response_object );
